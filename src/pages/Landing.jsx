...
function Landing() {
  ...
  return (
    ...
    <div className='landing_page'>
      <nav className='fixed backdrop-blur-md bg-opacity-30 z-10 bg-white/45 w-full border-white border shadow-sm h-16 py-2 px-3 '>
      ...
      <div className='h-screen flex flex-col justify-center items-center pt-48'>
        ...
        <section   className='text-center max-w-4xl'>
            <h1 data-aos="zoom-in-up" className='text-7xl font-bold mt-5 mb-4'>Resume On Demand.</h1>
            <h3 data-aos="zoom-in" className='text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-l from-[#364050] via-[#171F2E] to-[#6b90cf] '>For Free.</h3>
            <p className='mt-6 text-gray-500 text-wrap text-xl mx-24'>Ready to make an impact? Start building your resume today and take the first step toward your career goals!</p>            
            <button 
            ...
            <button
              ...
              About Us
              <i class="ml-3 text-[0.9rem] fa-solid fa-circle-up"></i>
            </button>    
              <ul className='flex gap-10 justify-center mt-9 text-[#757D88]'>
                <li><i className="mr-2 fa-regular fa-circle-check"></i>
                100% Free
                </li>
                <li><i class="mr-2 fa-solid fa-filter"></i> 
                Different Templates
                </li>
                <li><i class="mr-2 fa-solid fa-user-tie"></i>
      ...
      <section className='bg-[#10141F] rounded-t-[4rem] text-white py-10'>
        ...
        <div className='grid sm:grid-cols-2'> 
          ...
          <div className='mx-4 mb-11 py-3'>
              ...
              <p className='max-w-lg mt-2'>No need to worry about layout, formatting, or readability—we handle all of that for you.</p>
            </div>       
            <div data-aos="fade-up" className='mt-6 border-gray-700 border bg-[#1C2029] mx-3 rounded-3xl p-5 hover:bg-[#2d323c]'>
              <i className="ri-seo-fill text-4xl"></i>
              <h1 className='font-bold mt-2 text-xl' >Select a Template</h1>
              <p>Pick from professionally-designed templates tailored to make your resume stand out.</p>
            </div>

            <div data-aos="fade-up" className='mt-6 border-gray-700 border bg-[#1C2029] mx-3 rounded-3xl p-5 hover:bg-[#2d323c] '>            
              <i class="ri-bard-fill text-4xl"></i>
              <h1 className='font-bold mt-2 text-xl' >Customize Your Content</h1>
              <p>Fill in your details, skills, and experiences. Add, remove, or reorder sections effortlessly.</p>
            </div>
            <div data-aos="fade-up" className='mt-6 border-gray-700 border bg-[#1C2029] mx-3 rounded-3xl p-5 hover:bg-[#2d323c] '>            
              <i class="ri-download-line text-4xl"></i>
              <h1 className='font-bold mt-2 text-xl' >Download and Share</h1>
              <p>Save, download, or share your resume directly. Perfectly formatted, every time.</p>
            </div>
          </div>
          <div data-aos="fade-up" className='2ND_DIV mt-10'>
            ...
            <div className='mt-6 border-gray-700 border bg-[#1C2029] mx-4 rounded-3xl p-8 hover:bg-[#2d323c] '>            
              ...
              <p>Access industry-approved templates and formats that have been tried and tested.</p>
              <Link to={'/signup'}>
            ...
            <div className='mt-6 border-gray-700 border bg-[#1C2029] mx-4 rounded-3xl p-8 hover:bg-[#2d323c] '>            
              ...
              <p>Our team is here to help you make the most of your resume-building experience. Reach out to us anytime.</p>
